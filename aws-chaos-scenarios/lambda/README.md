...
- Make sure the credential used for creating secret should have the permission to perform Lambda chaos. [Click Here]() for a sample policy file for the fault.
