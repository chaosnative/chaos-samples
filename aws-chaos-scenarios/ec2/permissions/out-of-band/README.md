...
- Make sure the credential used for creating secret should have the permission to perform EC2 Stop chaos. [Click Here](./out-of-bound/permissions.json) for a sample policy file for the fault.
